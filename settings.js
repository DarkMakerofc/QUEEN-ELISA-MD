...
global.owner = ['94714900854'] 
//👇 Your Caption ( Image Video )
global.cap = '© 𝙶𝙴𝙽𝙴𝚁𝙰𝚃𝙴𝙳 𝙱𝚈 𝚀𝚄𝙴𝙴𝙽 𝙴𝙻𝙸𝚂𝙰 ²⁰²³'
//👇 Your Bot Name
global.botnma =  '𝙎𝙆 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋 𝙌𝙐𝙀𝙀𝙉 𝙀𝙇𝙄𝙎𝘼 𝙈𝘿 3 𝛁' 
//👇 Your name
global.ownernma =  'ᴍ ʀ ⃞ ɴ ɪ ᴍ ᴀ' 
//👇 Sticker Author Name
global.packname =  '𝙎𝙆 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋 𝘽𝙊𝙏♥️' 
//👇 Inbox Block Massage 
global.INBOX_BLOCK_MSG = 'BLOCK !!!'
//👇 Owner React Imoji
global.OWNER_REACT =  '💻'
//👇 Song Download Massage 
global.SONG_DOWN ='```⇣⇣⬇️𝘿𝙊𝙒𝙉𝙇𝙊𝘼𝘿 වෙනව ඉතින්🤪.......♥️ ```' 
//👇 Song Uplode massage 
global.SONG_UP = '```⇡⇡⬆️𝙐𝙋𝙇𝙊𝘼𝘿 වෙනව ඉතින්........😏♥️```'
//👇 Menu imoji 
...
global.LANG = 'EN'
//Alive logo
global.alivelogo = process.env.ALIVE_IMAGE || `https://telegra.ph/file/bd4f0b44f5dc2c729b182.jpg`
//👇 Alive message
global.ALIVE_MESSAGE = process.env.ALIVE_MESSAGE || `default`
//👇 Welcome Mesaage
global.WELCOME = process.env.WELCOME || `𝙷𝙸,𝚆𝙴𝙻𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝙼𝚈 𝙱𝙾𝚃 𝙶𝚁𝙾𝚄𝙿❤️👋`
//👇 welcome image 
global.WELCOME_IMAGE = process.env.WELCOME_IMAGE || `https://telegra.ph/file/9079eccdd2c08b2e832c2.jpg`
//👇 Goodbye message 
global.GOODBYE = process.env.GOODBYE || ``
//👇 Good bye image
global.GOODBYE_IMAGE = process.env.GOODBYE_IMAGE || ``
//👇 DISABLE PM Block numbers
global.NO_BLOCK = ["94705262620","94741130677"]
//👇 DISABLE download words
global.IMG_BLOCKER = ["xxx","sex","mia","https://chat.whatsapp.com/","xxnx","pron","brazzers","boobs","ass","wa.me//"]
//👇 Open ai API Put Withouth "sk-" ( "sk-" අයින් කරල ඉතුරු ටික දාන්න )
global.CHATGPT_API = ''
//👇 Sex  video Download Allowed Groups
global.SEX_DOWNLOAD_GROUPS = ['120363147404508506@g.us']
//👇 Your Bot Group Link
global.GROUP_LINK = 'https://chat.whatsapp.com/Do7mQTqQzFB69mi0CyoaGa'
/*
...
//other
global.pemilik = ['94714900854'] //Change  it , ඔබට කැමති නම් වෙනස් කරන්න
global.premium = ['94705262620'] //Change it ඔබට කැමතිනම් වෙනස් කරන්න 
global.pengguna = '𝙎𝙆 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋 𝘽𝙊𝙏' // Your name ඔබේ නම 
