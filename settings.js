...
global.mess = {
    success: '✅ Done!',
    admin: '*මෙම විධානය බාවිතකර හැක්කේ ඇඩ්මින්ලට පමනි 𝙾𝙽𝙻𝚈 𝙰𝙳𝙼𝙸𝙽🚫 !*',
    botAdmin: '*කරුනාකර බොට් ඇඩ්මින්කරන්න 𝙰𝙳𝙼𝙸𝙽 𝙿𝙻𝙴𝚂🔖!*',
    owner: '*කණගාටුයි , මෙම විධානය අයිතිකරුට පමනි❌𝙾𝙽𝙻𝚈 𝙾𝚆𝙽𝙴𝚁 !*',
