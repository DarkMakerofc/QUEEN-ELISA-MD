...
global.owner = ['+255 654 410 999 +255 687 680 998'] 
//👇 Your Caption ( Image Video )
global.cap = '© Bayuwe Bot ²⁰²³'
//👇 Your Bot Name
global.botnma =  'Bayuwe Bot' 
//👇 Your name
global.ownernma =  'Bayuwe' 
//👇 Sticker Author Name
global.packname =  'Bayuwe_Vagabond' 
//👇 Inbox Block Massage 
...
global.TIME_ZONE = process.env.TIME_ZONE || 'Tanzania/Zanzibar'
//👇 Removebg Api key
...
global.mess = {
    success: '✅ Done!',
    admin: '*Only Bayuwe can use this command !*',
    botAdmin: '*Please Bayuwe the bot first !*',
    owner: '*Sorry, this command is only for the owner Bayuwe !*',
    group: '*This command can only be used in groups !*',
    private: '*This command can only be used in Inbox !*',
    bot: '*This command can only be used by bot number !*',
    wait: '*♲ Please Wait ...*',
    endLimit: 'Your Daily Limit Has Expired, The Limit Will Be Reset Every 12 Hours',
    BLOCK_CMD_MSG : '*⚠️ This Command is Block By Bayuwe*',
...
//other
global.pemilik = ['255 687 680 998'] //Change  it , ඔබට කැමති නම් වෙනස් කරන්න
global.premium = ['255 654 410 999'] //Change it ඔබට කැමතිනම් වෙනස් කරන්න 
global.pengguna = 'Bayuwe' // Your name ඔබේ නම 
